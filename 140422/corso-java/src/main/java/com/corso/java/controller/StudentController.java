...
public class StudentController {
    ...
    String deleteById(@PathVariable String id) {
        ...
        return ResponseEntity.ok("Element deleted successfully").toString();
    }
}

/*
 implementa findById, findByName, findByNameAndPassport, findByPassport, count(conta gli elementi)
 */
